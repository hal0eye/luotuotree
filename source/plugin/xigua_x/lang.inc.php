...
if(submitcheck('dosubmit')){
    if(checkmobile()){
        cpmsg('no zuo no die!', "action=plugins&operation=config&do=$pluginid&identifier=xigua_x&pmod=lang", 'succeed');
    }
    ...
    cpmsg(lang('plugin/xigua_x', 'succeed'), "action=plugins&operation=config&do=$pluginid&identifier=xigua_x&pmod=lang", 'succeed');
}

showformheader("plugins&operation=config&do=$pluginid&identifier=xigua_x&pmod=lang");
showtableheader();
