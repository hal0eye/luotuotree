...
0
|| checktplrefresh('./template/xinrui_vmall/common/header.htm', './template/default/common/header_common.htm', 1538831855, '4', './data/template/4_4_common_header_portal_list.tpl.php', './template/xinrui_vmall', 'common/header_portal_list')
|| checktplrefresh('./template/xinrui_vmall/common/header.htm', './template/default/common/header_qmenu.htm', 1538831855, '4', './data/template/4_4_common_header_portal_list.tpl.php', './template/xinrui_vmall', 'common/header_portal_list')
|| checktplrefresh('./template/xinrui_vmall/common/header.htm', './template/xinrui_vmall/common/pubsearchform.htm', 1538831855, '4', './data/template/4_4_common_header_portal_list.tpl.php', './template/xinrui_vmall', 'common/header_portal_list')
;?>
