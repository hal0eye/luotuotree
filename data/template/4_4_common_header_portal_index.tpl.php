...
0
|| checktplrefresh('./template/xinrui_vmall/common/header.htm', './template/default/common/header_common.htm', 1538831852, '4', './data/template/4_4_common_header_portal_index.tpl.php', './template/xinrui_vmall', 'common/header_portal_index')
|| checktplrefresh('./template/xinrui_vmall/common/header.htm', './template/default/common/header_qmenu.htm', 1538831852, '4', './data/template/4_4_common_header_portal_index.tpl.php', './template/xinrui_vmall', 'common/header_portal_index')
|| checktplrefresh('./template/xinrui_vmall/common/header.htm', './template/xinrui_vmall/common/pubsearchform.htm', 1538831852, '4', './data/template/4_4_common_header_portal_index.tpl.php', './template/xinrui_vmall', 'common/header_portal_index')
;?>
...
<?php } ?>
<script src="template/xinrui_vmall/js/jquery-1.9.1.min.js" type="text/javascript" type="text/javascript"></script>
<script src="template/xinrui_vmall/js/jquery.SuperSlide.js" type="text/javascript" type="text/javascript"></script>
<script src="template/xinrui_vmall/js/nav.js" type="text/javascript" type="text/javascript"></script>
...
<?php } ?>
<ul>
<li class="scbar_txt_td"><input type="text" name="srchtxt" id="scbar_txt" value="请输入搜索内容" autocomplete="off" x-webkit-speech speech /></li>
<li class="scbar_type_td"><a href="javascript:;" id="scbar_type" class="xg1" onclick="showMenu(this.id)" hidefocus="true">搜索</a><i></i></li>
<li class="scbar_btn_td"><button type="submit" name="searchsubmit" id="scbar_btn" sc="1" class="pn pnc" value="true"><strong class="xi2">搜索</strong></button></li>
</ul>
</form>
</div>
...
<li class="navsign" style="left:0; width: 64px;"></li>
</ul>
