...
0
|| checktplrefresh('./template/xinrui_vmall/common/header.htm', './template/default/common/header_common.htm', 1538831859, '4', './data/template/4_4_common_header_forum_index.tpl.php', './template/xinrui_vmall', 'common/header_forum_index')
|| checktplrefresh('./template/xinrui_vmall/common/header.htm', './template/default/common/header_qmenu.htm', 1538831859, '4', './data/template/4_4_common_header_forum_index.tpl.php', './template/xinrui_vmall', 'common/header_forum_index')
|| checktplrefresh('./template/xinrui_vmall/common/header.htm', './template/xinrui_vmall/common/pubsearchform.htm', 1538831859, '4', './data/template/4_4_common_header_forum_index.tpl.php', './template/xinrui_vmall', 'common/header_forum_index')
;?>
