...
<ul class="chart z">
<li><em><?php echo $todayposts;?></em>今日帖数</li>
<li><em><?php echo $postdata['0'];?></em>昨日帖数</li>
<li><em><?php echo $posts;?></em>帖子数</li>
<li><em><?php echo $_G['cache']['userstats']['totalmembers'];?></em>会员总数</li>
</ul>
<div class="y">
...
<div class="fl_icn_g" <?php if(!empty($forum['extra']['iconwidth']) && !empty($forum['icon'])) { ?> style="width: <?php echo $forum['extra']['iconwidth'];?>px;margin:0 auto;"<?php } ?>>
<?php if($forum['icon']) { ?>
<?php echo $forum['icon'];?>
<?php } else { ?>
<a href="<?php echo $forumurl;?>"<?php if($forum['redirect']) { ?> target="_blank"<?php } ?>><img src="<?php echo IMGDIR;?>/forum<?php if($forum['folder']) { ?>_new<?php } ?>.gif" alt="<?php echo $forum['name'];?>" /></a>
...
<dl>
<dt><a href="<?php echo $forumurl;?>"<?php if($forum['redirect']) { ?> target="_blank"<?php } if($forum['extra']['namecolor']) { ?> style="color: <?php echo $forum['extra']['namecolor'];?>;"<?php } ?>><?php echo $forum['name'];?></a><em title="今日"> (<?php echo $forum['todayposts'];?>)</em><?php if($forum['todayposts'] && !$forum['redirect']) { } ?></dt>								
