...
0
|| checktplrefresh('./template/xinrui_vmall/common/header.htm', './template/default/common/header_common.htm', 1538837299, '4', './data/template/4_4_common_header_video_index.tpl.php', './template/xinrui_vmall', 'common/header_video_index')
|| checktplrefresh('./template/xinrui_vmall/common/header.htm', './template/default/common/header_qmenu.htm', 1538837299, '4', './data/template/4_4_common_header_video_index.tpl.php', './template/xinrui_vmall', 'common/header_video_index')
|| checktplrefresh('./template/xinrui_vmall/common/header.htm', './template/xinrui_vmall/common/pubsearchform.htm', 1538837299, '4', './data/template/4_4_common_header_video_index.tpl.php', './template/xinrui_vmall', 'common/header_video_index')
;?>
